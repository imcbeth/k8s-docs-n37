...
const config: Config = {
  ...
  tagline: 'Kubernetes cluster, monitoring, and infrastructure guides',
  ...
  url: 'https://imcbeth.github.io',
  // Set the /<baseUrl>/ pathname under which your site is served
  // For GitHub pages deployment, it is often '/<projectName>/'
  baseUrl: '/k8s-docs-n37/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'imcbeth', // Usually your GitHub org/user name.
  projectName: 'k8s-docs-n37', // Usually your repo name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/imcbeth/k8s-docs-n37/tree/main/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/imcbeth/k8s-docs-n37',
          label: 'GitHub',
          position: 'right',
        },
      ],
